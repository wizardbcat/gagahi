...
CREATE TABLE `comments` (
  ...
  KEY `item_id` (`item_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`),
...
CREATE TABLE `imgs` (
  ...
  PRIMARY KEY (`imgs_id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `imgs_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `likes` (
  ...
  KEY `item_id` (`item_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `likes_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`),
